...
#+STARTUP: overview
#+Title: Zeit APIs over GraphQL

* GETs [0/19]
** INPROGRESS [[https://zeit.co/docs/api/#endpoints/deployments/list-deployments][List Deployments]]
   - State "INPROGRESS" from "TODO"       [2019-03-12 Tue 15:30]
   ~GET /v3/now/deployments~
** TODO [[https://zeit.co/docs/api/#endpoints/deployments/get-a-single-deployment][Get a Single Deployment]]
   ~GET /v6/now/deployments/:id~
** TODO [[https://zeit.co/docs/api/#endpoints/deployments/list-deployment-files][List Deployment Files]]
